...
RUN rm -f /build/web/src/main/resources/config/logback-*.yml
...
COPY --from=build-stage /build/web/target/file-transformer-rda-web-1.0.0-SNAPSHOT.jar /app/file-transformer-rda-web.jar
